...
class VTUNotFound(Exception):
    """
    VTUNotFound is a custom exception that is raised when a path cannot 
    be found between two nodes in a pathfinding algorithm.
    """

    def __init__(self, message: str) -> None:
        """
        Initializes the VTUNotFound with a descriptive error message.
...
class NotSameLevelRoutingException(Exception):
    """
    VTUNotFound is a custom exception that is raised when a path cannot 
    be found between two nodes in a pathfinding algorithm.
    """
